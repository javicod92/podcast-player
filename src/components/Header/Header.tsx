    ...
    <div className={styles.top_bar}>
      <div className={styles.bar_left_content}>
        <button
          ...
          id="button"
          className={styles.bar_icon_btn}
        >
          <img src="/assets/static/svgs/menu.svg" alt="Menu" />
        </button>
      ...
      <div className={styles.bar_right_content}>
        <div className={styles.right_inner_content}>
          <div className={styles.right_inner_search}>
            <img src="/assets/static/svgs/FindIcon.svg" alt="Find Icon" />
            <input
          ...
          <div className={styles.user_content}>
            <button>
              <img src="/assets/static/svgs/cast.svg" alt="Cast" />
            </button>
            <AvatarAddon
