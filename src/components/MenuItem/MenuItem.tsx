...
type Props = {
  ...
  hasRightIcon?: true;
  leftIconUrl?: string;
  buttonSize: "vertical" | "horizontal";
  isSelected?: true;
}

export default function MenuItem (props: Props) {
  return(
    <button className={`${props.buttonSize === "vertical" ? styles.vertically_button_container : styles.horizontally_button_container} ${props.isSelected && styles.isSelected}`}>
      ...
      {props.hasRightIcon && <img src="src/assets/static/svgs/iconForMenu.svg" alt="Icon for Menu" />}
    </button>
  )
}